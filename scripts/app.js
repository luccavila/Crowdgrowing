...
const marcasGrandes = ['Nike', 'Jordan', 'Adidas', 'Puma', 'Asics', 'New Balance']
const tallesHombre = ['38', '39', '40', '41', '42', '43', '44']

const modelosEnVenta = [{
        id: 1,
        categoria: "Hombre",
        marca: "New Balance",
        modelo: "ninja",
...
//Ordenando arrays
let talleDeseado = parseInt(prompt("Que talle buscas ?"));
const talleBuscado = modelosEnVenta.find(Calzado => Calzado.talle === talleDeseado);
alert(talleBuscado)